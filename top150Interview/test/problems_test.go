...
func TestProblems(t *testing.T) {
	...
	t.Logf("%s: %+v", "21. Merge Two Sorted Lists.go", problems.MergeTwoLists(&problems.ListNode{Val: 1, Next: &problems.ListNode{Val: 2, Next: &problems.ListNode{Val: 4, Next: nil}}}, &problems.ListNode{Val: 1, Next: &problems.ListNode{Val: 3, Next: &problems.ListNode{Val: 4, Next: nil}}}))
